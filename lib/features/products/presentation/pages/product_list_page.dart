      ...
      child: _isFilterExpanded
          ? Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('Mức giá', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                  const SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('${(_currentMinPrice / 1000000).toStringAsFixed(1)} Tr', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold, fontSize: 12)),
                      Text('${(_currentMaxPrice / 1000000).toStringAsFixed(1)} Tr', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold, fontSize: 12)),
                    ],
                  ),
                  RangeSlider(
                  ...
                  const Text('Dung lượng RAM', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                  ...
                  const SizedBox(height: 16),
                  const Text('Bộ nhớ trong (ROM)', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                ...
                if (state is ProductLoading) {
                  ...
                  return GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      childAspectRatio: 0.62, // Taller cards to fit new product card design
                      crossAxisSpacing: 16,
                      mainAxisSpacing: 16,
                    ),
